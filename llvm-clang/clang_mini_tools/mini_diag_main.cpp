//core_diag_main.cpp william k. johnson 2015
...
{
    cl::ParseCommandLineOptions( argc , argv , "clang_mini_diag" );
    const char* dargs[] = { "-x" ,
                            "c++" ,
                            "-std=c++11" ,
                            "-I../../include" ,
    ...
    std::unique_ptr<clang_mini_diag> mini( new clang_mini_diag( filename , targs ) );
    mini->perform();
